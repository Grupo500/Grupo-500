...
app.listen(PORT, () => {
  ...
  // Envío semanal de cuentas de cobro a Drive: el sábado a las 23:59, UNA
  // cuenta por freelance con todos sus trabajos aprobados. El candado del
  // corte vive en ConfigApp, así que revisar cada minuto es barato y
