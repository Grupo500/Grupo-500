...
import { sincronizarTodosEstudiantes } from '../controllers/hotmart.controller'
...
router.post('/sincronizar-hotmart', requireRole('ADMIN'), asyncHandler(sincronizarTodosEstudiantes))
