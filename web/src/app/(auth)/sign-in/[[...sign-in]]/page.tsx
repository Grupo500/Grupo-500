...
export default function SignInPage() {
  ...
  return (
    <div
      className={`${poppins.className} relative h-dvh w-full overflow-y-auto overflow-x-hidden flex flex-col items-center justify-center gap-4 px-4 py-4`}
      style={{ background: 'linear-gradient(160deg, #003060 0%, #2094ff 55%, #21b9f7 100%)' }}
    >
      {/* Halos de luz animados de fondo */}
      <div className="absolute -top-24 -left-20 w-72 h-72 rounded-full bg-[#635cef]/30 blur-3xl pointer-events-none animate-float-slow" aria-hidden />
      <div className="absolute -bottom-28 -right-16 w-80 h-80 rounded-full bg-[#95daff]/25 blur-3xl pointer-events-none animate-float-slow delay-2" aria-hidden />
      <div className="absolute top-1/3 right-8 w-40 h-40 rounded-full bg-[#4361ee]/20 blur-2xl pointer-events-none animate-float-slow delay-3 hidden md:block" aria-hidden />

      {/* Contenido encima */}
      <div className="relative z-10 flex flex-col items-center gap-5 w-full max-w-sm px-4 my-auto">

        {/* Logo — único lugar de la app donde aparece, sobre fondo azul */}
        <div className="flex flex-col items-center gap-2 animate-card-enter">
          <div className="w-24 h-24 rounded-3xl bg-white/95 shadow-[0_12px_40px_-8px_rgba(0,30,60,0.45)] flex items-center justify-center p-3 ring-1 ring-white/40 animate-logo-pulse">
            <Image
        ...
        <div className="text-center animate-slide-up delay-1">
          <p className="text-2xl font-extrabold text-white tracking-tight drop-shadow-sm">Grupo 500</p>
          <p className="text-sm text-white/85 font-medium tracking-wide">Pre-ICFES</p>
        </div>
          ...
          <div className={`bg-white/97 backdrop-blur-sm rounded-2xl border border-white/30 shadow-[0_20px_50px_-12px_rgba(0,30,60,0.5)] p-5 space-y-4 transition-all duration-300 ${shake ? 'animate-shake' : ''}`}>
            ...
            {supportsWebAuthn && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 border border-[#1a7de0]/30 hover:bg-[#1a7de0]/5 hover:border-[#1a7de0]/50 transition-all duration-200 active:scale-[0.97] rounded-xl py-2.5 text-sm font-medium text-[#1a7de0] disabled:opacity-60"
              >
                {faceLoading
            ...
            <form onSubmit={handleCredentials} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="w-full border border-black/[0.10] focus:border-[#1a7de0]/50 focus:ring-2 focus:ring-[#1a7de0]/15 rounded-xl text-[13px] py-2.5 px-3 bg-[#f4f8ff] text-[#001d3d] outline-none transition-all duration-200"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-black/[0.10] focus:border-[#1a7de0]/50 focus:ring-2 focus:ring-[#1a7de0]/15 rounded-xl text-[13px] py-2.5 pl-3 pr-10 bg-[#f4f8ff] text-[#001d3d] outline-none transition-all duration-200"
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-[#2094ff] to-[#1a7de0] hover:brightness-105 text-white font-semibold rounded-xl py-2.5 text-sm transition-all duration-200 active:scale-[0.97] shadow-[0_8px_20px_-6px_rgba(26,125,224,0.55)] disabled:opacity-60 flex items-center justify-center gap-2"
              >
